  ...
  const statsData = [
    {
      value: "10,000+",
      label: "HAPPY USERS",
      description: "A trusted community network connecting daily users with premium Jewish-owned businesses and services across the region.",
      theme: "light-green",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="w-7 h-7 text-[#085027]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    },
    {
      ...
      description: "An extensive directory featuring verified local shops, kosher markets, and essential Gift stores near you",
      theme: "cream-green",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="w-7 h-7 text-[#085027]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    },
    {
      value: "20+",
      label: "KEY LOCATIONS",
      description: "Strategically mapped across key major states and vibrant local neighborhoods to bring the best options to your doorstep.",
      theme: "dark-green",
      icon: (
          ...
          {statsData.map((stat, i) => {
            ...
            return (
              <div
                ...
                } rounded-tl-[30px] rounded-br-[30px] md:rounded-tl-[60px] md:rounded-br-[60px] rounded-tr-lg rounded-bl-lg p-4 sm:p-10 flex flex-col items-start text-left transition-transform duration-300 hover:-translate-y-1`}
              >
                {/* Icon wrapper */}
                <div
