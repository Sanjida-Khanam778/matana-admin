...
function EmailIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#1a5c3a" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
function PhoneIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#d4a017" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
function InstagramIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="url(#ig-grad)" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <defs>
    ...
    <section id="contact" className="w-full bg-gradient-to-br from-[#1E4D2B]/5 to-[#D4AF37]/5 py-16 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-sm lg:text-base text-gray-500">Have questions? We're here to help you find what you need.</p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-6 items-start">
          ...
          <div className="flex flex-col gap-4">
            {contactItems.map((item) => (
              <div key={item.title} className="bg-white rounded-2xl border border-gray-100 shadow-sm px-5 py-5 flex items-start gap-4">
                <div className={`w-11 h-11 rounded-xl ${item.iconBg} flex items-center justify-center flex-shrink-0`}>
                  {item.icon}
                </div>
                <div>
                  <p className="text-sm lg:text-base font-bold text-gray-900 mb-0.5">{item.title}</p>
                  <p className="text-xs lg:text-sm text-gray-500 mb-1.5">{item.subtitle}</p>
                  <p className={`text-sm lg:text-base text-primary font-semibold`}>{item.value}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm px-6 py-7">
            ...
            <div className="space-y-4">
              ...
              {/* Message */}
              <div>
                <label className="block text-sm lg:text-base font-medium text-gray-700 mb-1.5">Message</label>
                <textarea
                  rows={5}
